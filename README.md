...
A community-generated interactive API reference (built with [Sourcey](https://github.com/sourcey-co/sourcey)) is also available at [0xConsole.github.io/meilisearch-sourcey-docs](https://0xconsole.github.io/meilisearch-sourcey-docs/) — it provides searchable, source-mapped documentation for all 73 Meilisearch API operations extracted from the OpenAPI specification.

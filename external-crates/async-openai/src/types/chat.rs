    ...
    D: serde::Deserializer<'de>,
{
    ...
    match v {
        ...
        serde_json::Value::Array(items) => {
            // Mistral can stream `delta.content` as an array of parts like:
            // [{"type":"reference","reference_ids":[]},{"type":"text","text":"..."}]
            // Keep API compatibility by extracting and concatenating `text` parts,
            // ignoring non-text parts (e.g. references).

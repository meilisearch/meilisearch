...
const MEILI_EXPERIMENTAL_HNSW_NO_LINEAR_ABOVE: &str = "MEILI_EXPERIMENTAL_HNSW_NO_LINEAR_ABOVE";
...
impl VectorStore {
    ...
    fn _hannoy_nns_by_item<D: hannoy::Distance>(
        ...
        for reader in self._hannoy_readers(rtxn, db) {
            ...
            searcher
                .no_linear_above(env_var_or(MEILI_EXPERIMENTAL_HNSW_NO_LINEAR_ABOVE, 1_000_000));

...
/// A codec that encodes and decodes delta-encoded RoaringBitmaps.
///
/// DeRoaringBitmap stands for "Delta-Encoded RoaringBitmap" where Delta-Encoded
/// means that the bitmap is stored with a delta encoding codec.
...
impl DeRoaringBitmapCodec {
    ...
    pub fn serialized_size_with_tmp_buffer(
        ...
        let mut size = size_of_val(&MAGIC_HEADER);

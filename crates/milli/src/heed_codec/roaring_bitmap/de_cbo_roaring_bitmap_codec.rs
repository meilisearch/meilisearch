...
/// A codec that encodes and decodes a delta-encoded CboRoaringBitmap.
///
/// DeCboRoaringBitmap stands for "Delta-Encoded Conditional ByteOrder RoaringBitmap"
/// where ByteOrder means storing items (u32) directly in the byte array, ordered and
/// where Delta-Encoded means that the bitmap is stored with a delta encoding codec.

...
use crate::update::index_documents::{
    ...
    write_sorter_into_database, CursorCloneableMmap, MergeDeladdCboRoaringBitmaps,
};
...
impl<'t, 'i> WordPrefixIntegerDocids<'t, 'i> {
    ...
    pub fn execute(
        self,
        new_word_integer_docids: grenad::Merger<CursorCloneableMmap, MergeDeladdCboRoaringBitmaps>,

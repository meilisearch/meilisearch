...
impl<'a, 'i> Transform<'a, 'i> {
        ...
        FP: Fn(UpdateIndexingStep) + Sync,
    {
        ...
        while let Some(enriched_document) = cursor.next_enriched_document()? {
            ...
            // we must insert this document id into the remapped document.
    ...
    /// then fill the provided buffers with delta documents using KvWriterDelAdd.
    ...
    fn rebind_existing_document(
        ...
        // Always provide all fields when vectors are involved because

...
#[utoipa::path(
    ...
    responses(
        (status = OK, description = "Experimental features are returned", body = RuntimeTogglableFeatures, content_type = "application/json", example = json!(RuntimeTogglableFeatures {
            ...
            embedding_url_fetching: Some(false),
        })),
...
pub struct RuntimeTogglableFeatures {
    ...
    #[deserr(default)]
    pub embedding_url_fetching: Option<bool>,
}
...
impl From<meilisearch_types::features::RuntimeTogglableFeatures> for RuntimeTogglableFeatures {
    fn from(value: meilisearch_types::features::RuntimeTogglableFeatures) -> Self {
        ...
        Self {
            ...
            embedding_url_fetching: Some(embedding_url_fetching),
        }
    }
}
...
impl Aggregate for PatchExperimentalFeatureAnalytics {
    ...
    fn aggregate(self: Box<Self>, new: Box<Self>) -> Box<Self> {
        Box::new(Self {
            ...
            embedding_url_fetching: new.embedding_url_fetching,
...
async fn patch_features(
    ...
    let new_features = meilisearch_types::features::RuntimeTogglableFeatures {
        ...
        embedding_url_fetching: new_features
            .0
            .embedding_url_fetching
            .unwrap_or(old_features.embedding_url_fetching),
    };

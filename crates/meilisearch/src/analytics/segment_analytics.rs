...
impl Infos {
    pub fn new(options: Opt, features: RuntimeTogglableFeatures) -> Self {
        ...
        let Opt {
            ...
            cluster_bind: _,
            cluster_node_id: _,
            cluster_heartbeat_ms: _,
            cluster_election_timeout_min_ms: _,
            cluster_election_timeout_max_ms: _,
            cluster_accept_timeout_ms: _,
            cluster_max_message_size_mb: _,
            cluster_raft_db_size_mb: _,
            cluster_max_transfer_failures: _,
            cluster_max_replication_lag: _,
            cluster_write_timeout_secs: _,
            cluster_status_url: _,
            cluster_leave_url: _,
            cluster_show_secret: _,
            cluster_reset: _,
            cluster_enable_test_endpoints: _,
            cluster_snapshot_max_compaction_age_s: _,
            cluster_tls: _,
        } = options;

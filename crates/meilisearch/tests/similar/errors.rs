...
async fn similar_bad_id() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.meilisearch.com/errors#invalid-similar-id"
    }
    "###);
}
...
async fn similar_not_found_id() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.meilisearch.com/errors#not-found-similar-id"
    }
    "###);
}
...
async fn similar_bad_offset() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.meilisearch.com/errors#invalid-similar-offset"
    }
    "###);
...
async fn similar_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.meilisearch.com/errors#invalid-similar-limit"
    }
    "###);
...
async fn similar_bad_filter() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.meilisearch.com/errors#invalid-similar-filter"
    }
    "###);
...
async fn similar_bad_embedder() {
    ...
    "type": "invalid_request",
    "link": "https://docs.meilisearch.com/errors#invalid-similar-embedder"
    });

...
async fn create_api_key_bad_description() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-api-key_description"
    }
    "###);
}
...
async fn create_api_key_bad_name() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-api-key_name"
    }
    "###);
}
...
async fn create_api_key_bad_uid() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-api-key_uid"
    }
    "###);
...
async fn create_api_key_bad_actions() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-api-key_actions"
    }
    "###);
...
async fn create_api_key_bad_indexes() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-api-key_indexes"
    }
    "###);
...
async fn create_api_key_missing_action() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#missing-api-key-actions"
    }
    "###);
}
...
async fn create_api_key_missing_indexes() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#missing-api-key-indexes"
    }
    "###);
}
...
async fn create_api_key_missing_expires_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#missing-api-key-expires-at"
    }
    "###);
}
...
async fn list_api_keys_bad_offset() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-api-key_offset"
    }
    "###);
}
...
async fn list_api_keys_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-api-key_limit"
    }
    "###);
}
...
async fn patch_api_keys_immutable_uid() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#immutable-api-key-uid"
    }
    "###);
}
...
async fn patch_api_keys_immutable_actions() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#immutable-api-key-actions"
    }
    "###);
}
...
async fn patch_api_keys_immutable_indexes() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#immutable-api-key-indexes"
    }
    "###);
}
...
async fn patch_api_keys_immutable_expires_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#immutable-api-key-expires-at"
    }
    "###);
}
...
async fn patch_api_keys_immutable_created_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#immutable-api-key-created-at"
    }
    "###);
}
...
async fn patch_api_keys_immutable_updated_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#immutable-api-key-updated-at"
    }
    "###);
}

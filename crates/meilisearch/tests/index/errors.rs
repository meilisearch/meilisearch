...
async fn get_indexes_bad_offset() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "link": "https://docs.meilisearch.com/errors#invalid-index-offset"
    }
    "###);
}
...
async fn get_indexes_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.meilisearch.com/errors#invalid-index-limit"
    }
    "###);
}
...
async fn create_index_bad_primary_key() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.meilisearch.com/errors#invalid-index-primary-key"
    }
    "###);
}
...
async fn update_index_immutable_uid() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.meilisearch.com/errors#immutable-index-uid"
    }
    "###);
}
...
async fn update_index_immutable_updated_at() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://docs.meilisearch.com/errors#immutable-index-updated-at"
    }
    "###);
}

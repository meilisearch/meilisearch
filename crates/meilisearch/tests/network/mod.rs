...
async fn errors_on_param() {
    ...
    meili_snap::snapshot!(meili_snap::json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-network-self"
    }
    "###);
    ...
    meili_snap::snapshot!(meili_snap::json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-network-remotes"
    }
    "###);
    ...
    meili_snap::snapshot!(meili_snap::json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#missing-network-url"
    }
    "###);
    ...
    meili_snap::snapshot!(meili_snap::json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-network-url"
    }
    "###);
    ...
    meili_snap::snapshot!(meili_snap::json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-network-search-api-key"
    }
    "###);

...
async fn get_all_documents_bad_offset() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-document-offset"
    }
    "###);
...
async fn get_all_documents_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-document-limit"
    }
    "###);
...
async fn get_all_documents_bad_filter() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-document-filter"
    }
    "###);
...
async fn replace_documents_bad_csv_delimiter() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-document-csv-delimiter"
    }
    "###);
...
async fn delete_document_by_filter() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#missing-document-filter"
    }
    "###);
...
async fn fetch_document_by_filter() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-document-fields"
    }
    "###);
...
async fn retrieve_vectors() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid_document_retrieve_vectors"
    }
    "###);

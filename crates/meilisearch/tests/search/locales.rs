...
async fn invalid_locales() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-locales"
    }
    "###);
...
async fn invalid_localized_attributes_rules() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-settings-localized-attributes"
    }
    "###);

...
async fn error_params() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-multi-search-remote"
    }
    "###);
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-multi-search-query-position"
    }
    "###);
}
    ...
    snapshot!(json_string!(response, { ".processingTimeMs" => "[time]" }), @r###"
    {
      ...
      "remoteErrors": {
        "ms1": {
          ...
          "type": "system",
          "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#remote-bad-response"
        }
      }
    }
    "###);
...
async fn error_bad_request() {
    ...
    snapshot!(json_string!(response, { ".processingTimeMs" => "[time]" }), @r###"
    {
      ...
      "remoteErrors": {
        "ms1": {
          "message": "remote host responded with code 400:\n  - response from remote: {\"message\":\"Inside `.queries[1]`: Index `nottest` not found.\",\"code\":\"index_not_found\",\"type\":\"invalid_request\",\"link\":\"https://www.meilisearch.com/docs/reference/errors/error_codes#index-not-found\"}\n  - hint: check that the remote instance has the correct index configuration for that request\n  - hint: check that the `network` experimental feature is enabled on the remote instance",
          "code": "remote_bad_request",
          "type": "invalid_request",
          "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#remote-bad-request"
        }
      }
    }
    "###);
...
async fn error_bad_request_facets_by_index() {
    ...
    snapshot!(json_string!(response, { ".processingTimeMs" => "[time]" }), @r###"
    {
      ...
      "remoteErrors": {
        "ms1": {
          "message": "remote host responded with code 400:\n  - response from remote: {\"message\":\"Inside `.federation.facetsByIndex.test0`: Index `test0` not found.\\n - Note: index `test0` is not used in queries\",\"code\":\"index_not_found\",\"type\":\"invalid_request\",\"link\":\"https://www.meilisearch.com/docs/reference/errors/error_codes#index-not-found\"}\n  - hint: check that the remote instance has the correct index configuration for that request\n  - hint: check that the `network` experimental feature is enabled on the remote instance",
          "code": "remote_bad_request",
          "type": "invalid_request",
          "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#remote-bad-request"
        }
    ...
    snapshot!(json_string!(response, { ".processingTimeMs" => "[time]" }), @r###"
    {
      ...
      "remoteErrors": {
        "ms2": {
          ...
          "type": "system",
          "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#remote-could-not-send-request"
        }
      }
    }
    "###);
    ...
    snapshot!(json_string!(response, { ".processingTimeMs" => "[time]" }), @r###"
    {
      ...
      "remoteErrors": {
        "ms1-notsearch": {
          ...
          "type": "auth",
          "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#remote-invalid-api-key"
        },
        "ms1-nottest": {
          "message": "could not authenticate against the remote host\n  - hint: check that the remote instance was registered with a valid API key having the `search` action",
          "code": "remote_invalid_api_key",
...
async fn error_remote_500() {
    ...
    snapshot!(json_string!(response, { ".processingTimeMs" => "[time]" }), @r###"
    {
      ...
      "remoteErrors": {
        "ms1": {
          "message": "remote host responded with code 500:\n  - response from remote: {\"error\":\"provoked error\",\"code\":\"test_error\",\"link\":\"https://www.meilisearch.com/docs/reference/errors/error_codes#test_error\"}",
          "code": "remote_remote_error",
          "type": "system",
          "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#remote-remote-error"
        }
      }
    }
    "###);
    ...
    snapshot!(json_string!(response, { ".processingTimeMs" => "[time]" }), @r###"
    {
      ...
      "remoteErrors": {
        "ms1": {
          ...
          "code": "remote_timeout",
          "type": "system",
          "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#remote-timeout"
        }
      }
    }
    "###);
...
fn fail(override_response_body: Option<&str>) -> ResponseTemplate {
    ...
    if let Some(override_response_body) = override_response_body {
        ...
        response.set_body_json(json!({"error": "provoked error", "code": "test_error", "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#test_error"}))
    }
}

...
async fn federation_sort_same_indexes_same_criterion_opposite_direction() {
    ...
    insta::assert_json_snapshot!(response, { ".processingTimeMs" => "[time]" }, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid_multi_search_query_ranking_rules"
    }
    "###);
...
async fn federation_invalid_weight() {
    ...
    insta::assert_json_snapshot!(response, { ".processingTimeMs" => "[time]" }, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-multi-search-weight"
    }
    "###);
}
...
async fn federation_federated_contains_pagination() {
    ...
    insta::assert_json_snapshot!(response, { ".processingTimeMs" => "[time]" }, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-multi-search-query-pagination"
    }
    "###);
...
async fn federation_federated_contains_facets() {
    ...
    insta::assert_json_snapshot!(response, { ".processingTimeMs" => "[time]" }, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-multi-search-query-facets"
    }
    "###);
}
...
async fn federation_non_faceted_for_an_index() {
    ...
    insta::assert_json_snapshot!(response, { ".processingTimeMs" => "[time]" }, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-multi-search-facets"
    }
    "###);
...
async fn federation_non_federated_contains_federation_option() {
    ...
    insta::assert_json_snapshot!(response, { ".processingTimeMs" => "[time]" }, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid_multi_search_federation_options"
    }
    "###);
}
...
async fn federation_inconsistent_merge_order() {
  ...
  .await;
    ...
    insta::assert_json_snapshot!(response, { ".processingTimeMs" => "[time]" }, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-multi-search-facet-order"
    }
    "###);

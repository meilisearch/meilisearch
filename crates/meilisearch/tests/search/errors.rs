...
async fn search_bad_q() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-q"
    }
    "###);
...
async fn search_bad_offset() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-offset"
    }
    "###);
...
async fn search_bad_limit() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-limit"
    }
    "###);
...
async fn search_bad_page() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-page"
    }
    "###);
...
async fn search_bad_hits_per_page() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-hits-per-page"
    }
    "###);
...
async fn search_bad_attributes_to_retrieve() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-attributes-to-retrieve"
    }
    "###);
...
async fn search_bad_retrieve_vectors() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid_search_retrieve_vectors"
    }
    "###);
...
async fn search_bad_attributes_to_crop() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-attributes-to-crop"
    }
    "###);
...
async fn search_bad_crop_length() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-crop-length"
    }
    "###);
...
async fn search_bad_attributes_to_highlight() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-attributes-to-highlight"
    }
    "###);
...
async fn search_bad_sort() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-sort"
    }
    "###);
...
async fn search_bad_show_matches_position() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-show-matches-position"
    }
    "###);
...
async fn search_bad_facets() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-facets"
    }
    "###);
    // Can't make the `attributes_to_highlight` fail with a get search since it'll accept anything as an array of strings.
}
...
async fn search_bad_threshold() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-ranking-score-threshold"
    }
    "###);
}
...
async fn search_bad_highlight_pre_tag() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-highlight-pre-tag"
    }
    "###);
...
async fn search_bad_highlight_post_tag() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-highlight-post-tag"
    }
    "###);
...
async fn search_bad_crop_marker() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-crop-marker"
    }
    "###);
...
async fn search_bad_matching_strategy() {
    ...
    snapshot!(json_string!(response), @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-matching-strategy"
    }
    "###);
    ...
    test_settings_documents_indexing_swapping_and_search(
        ...
        |response, code| {
            ...
            snapshot!(response, @r###"
            {
              ...
              "type": "invalid_request",
              "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid-search-attributes-to-search-on"
            }
            "###);
        },
    )
...
async fn distinct_at_search_time() {
    ...
    snapshot!(response, @r###"
    {
      ...
      "type": "invalid_request",
      "link": "https://www.meilisearch.com/docs/reference/errors/error_codes#invalid_search_distinct"
    }
    "###);

...
- ⚠️ If there is an change in the DB: it's mandatory to manually test the dumpless upgrade by opening a DB of the previous Meilisearch minor version with the new binary (e.g. v1.13 for the v1.14 release).

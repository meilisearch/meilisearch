...
impl Main {
    ...
    pub fn created_at(self, reader: &heed::RoTxn<MainT>) -> MResult<Option<DateTime<Utc>>> {
        Ok(self
            .main
            .get::<_, Str, SerdeDatetime>(reader, CREATED_AT_KEY)?)
    }
    ...
    pub fn updated_at(self, reader: &heed::RoTxn<MainT>) -> MResult<Option<DateTime<Utc>>> {
        Ok(self
            .main
            .get::<_, Str, SerdeDatetime>(reader, UPDATED_AT_KEY)?)
    }

    pub fn put_internal_docids(
        self,
        writer: &mut heed::RwTxn<MainT>,
        ids: &sdset::Set<DocumentId>,
    ) -> MResult<()> {
        Ok(self
            .main
            .put::<_, Str, DocumentsIds>(writer, INTERNAL_DOCIDS_KEY, ids)?)
    }

    pub fn internal_docids<'txn>(
        self,
        reader: &'txn heed::RoTxn<MainT>,
    ) -> MResult<Cow<'txn, sdset::Set<DocumentId>>> {
        match self
            .main
            .get::<_, Str, DocumentsIds>(reader, INTERNAL_DOCIDS_KEY)?
        {
            Some(ids) => Ok(ids),
            None => Ok(Cow::default()),
        }
    ...
    where
        A: AsRef<[u8]>,
    {
        Ok(self.main.put::<_, Str, ByteSlice>(
            writer,
            EXTERNAL_DOCIDS_KEY,
            ids.as_fst().as_bytes(),
        )?)
    ...
    pub fn merge_external_docids<A>(
        self,
        writer: &mut heed::RwTxn<MainT>,
        new_docids: &fst::Map<A>,
    ) -> MResult<()>
    where
        A: AsRef<[u8]>,
    {
    ...
    pub fn remove_external_docids<A>(
        self,
        writer: &mut heed::RwTxn<MainT>,
        ids: &fst::Map<A>,
    ) -> MResult<()>
    ...
    pub fn external_docids(self, reader: &heed::RoTxn<MainT>) -> MResult<FstMapCow> {
        match self
            .main
            .get::<_, Str, ByteSlice>(reader, EXTERNAL_DOCIDS_KEY)?
        {
            Some(bytes) => Ok(fst::Map::new(bytes)
                .unwrap()
    ...
    pub fn put_words_fst<A: AsRef<[u8]>>(
        ...
        Ok(self
            .main
            .put::<_, Str, ByteSlice>(writer, WORDS_KEY, fst.as_fst().as_bytes())?)
    }
    ...
    pub fn put_sorted_document_ids_cache(
        ...
        Ok(self.main.put::<_, Str, CowSlice<DocumentId>>(
            writer,
            SORTED_DOCUMENT_IDS_CACHE_KEY,
            documents_ids,
        )?)
    }

    pub fn sorted_document_ids_cache(
        self,
        reader: &heed::RoTxn<MainT>,
    ) -> MResult<Option<Cow<[DocumentId]>>> {
        Ok(self
            .main
    ...
    pub fn put_synonyms_fst<A: AsRef<[u8]>>(
        self,
        writer: &mut heed::RwTxn<MainT>,
        fst: &fst::Set<A>,
    ) -> MResult<()> {
        ...
        Ok(self
            .main
            .put::<_, Str, ByteSlice>(writer, SYNONYMS_KEY, bytes)?)
    }
    ...
    pub fn put_stop_words_fst<A: AsRef<[u8]>>(
        self,
        writer: &mut heed::RwTxn<MainT>,
        fst: &fst::Set<A>,
    ) -> MResult<()> {
    ...
    pub fn put_fields_distribution(
        ...
        Ok(self.main.put::<_, Str, SerdeFreqsMap>(
            writer,
    ...
    pub fn attributes_for_faceting<'txn>(
        ...
        Ok(self
            .main
            .get::<_, Str, CowSet<FieldId>>(reader, ATTRIBUTES_FOR_FACETING_KEY)?)
    }
    ...
    pub fn put_attributes_for_faceting(
        ...
        Ok(self.main.put::<_, Str, CowSet<FieldId>>(
            writer,
            ATTRIBUTES_FOR_FACETING_KEY,
            attributes,
        )?)
    }
    ...
    pub fn delete_attributes_for_faceting(self, writer: &mut heed::RwTxn<MainT>) -> MResult<bool> {
        Ok(self
            .main
            .delete::<_, Str>(writer, ATTRIBUTES_FOR_FACETING_KEY)?)
    }
    ...
    pub fn put_ranking_rules(
        self,
        writer: &mut heed::RwTxn<MainT>,
        value: &[RankingRule],
    ) -> MResult<()> {
        Ok(self.main.put::<_, Str, SerdeBincode<Vec<RankingRule>>>(
            writer,
            RANKING_RULES_KEY,
            &value.to_vec(),
        )?)
    ...
    pub fn distinct_attribute(&self, reader: &heed::RoTxn<MainT>) -> MResult<Option<FieldId>> {
        match self
            .main
            .get::<_, Str, OwnedType<u16>>(reader, DISTINCT_ATTRIBUTE_KEY)?
        {

use super::{Context, ContextMut, Criterion};
...
impl Criterion for Exactness {
    ...
    fn prepare<'h, 'p, 'tag, 'txn, 'q, 'r>(
        ...
        'documents: for doc in documents {
            doc.bare_matches
                .sort_unstable_by_key(|bm| (bm.query_index, Reverse(bm.is_exact)));
    ...
    fn evaluate(&self, _ctx: &Context, lhs: &RawDocument, rhs: &RawDocument) -> Ordering {
        ...
        lhs.contains_one_word_field
            .cmp(&rhs.contains_one_word_field)
            .reverse()
